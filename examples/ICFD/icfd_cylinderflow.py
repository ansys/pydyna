...
# | 3) Set Inflow velocity (*ICFD_BOUNDARY_PRESCRIBED_VEL) in DOF X to be 1.0 assocaited with a curve 0 to 10000.
# | 4) Set Inflow velocity (*ICFD_BOUNDARY_PRESCRIBED_VEL) in DOF Y to be 0.0 assocaited with a curve 0 to 10000.
...
# | 3) Set zero gauge pressure (*ICFD_BOUNDARY_PRESCRIBED_PRE) to the part 2 assocaited with a curve 0 to 10000.
