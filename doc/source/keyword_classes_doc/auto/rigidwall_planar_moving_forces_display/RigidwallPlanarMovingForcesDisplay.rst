...
:class:`RigidwallPlanarMovingForcesDisplay`
===========================================


.. py:class:: rigidwall_planar_moving_forces_display.RigidwallPlanarMovingForcesDisplay(**kwargs)
...
.. py:currentmodule:: RigidwallPlanarMovingForcesDisplay
...
.. py:attribute:: subkeyword
   :value: 'PLANAR_MOVING_FORCES_DISPLAY'
