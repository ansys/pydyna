...
:class:`RigidwallPlanarMovingDisplayId`
=======================================


.. py:class:: rigidwall_planar_moving_display_id.RigidwallPlanarMovingDisplayId(**kwargs)
...
.. py:currentmodule:: RigidwallPlanarMovingDisplayId
...
.. py:attribute:: subkeyword
   :value: 'PLANAR_MOVING_DISPLAY_ID'
