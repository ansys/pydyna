...
:class:`ElementMassMatrixNodeSet`
=================================


.. py:class:: element_mass_matrix_node_set.ElementMassMatrixNodeSet(**kwargs)

   Bases: :py:obj:`ansys.dyna.core.lib.keyword_base.KeywordBase`


   
   DYNA ELEMENT_MASS_MATRIX_NODE_SET keyword
...
.. py:currentmodule:: ElementMassMatrixNodeSet
...
.. tab-set::
   ...
   .. tab-item:: Properties
      ...
      .. list-table::
          ...
          * - :py:attr:`~id`
            - Get or set the node set ID.  This is node set to which the mass is assigned.
          * - :py:attr:`~cid`
