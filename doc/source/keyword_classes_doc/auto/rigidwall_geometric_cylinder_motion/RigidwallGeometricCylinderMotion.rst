...
:class:`RigidwallGeometricCylinderMotion`
=========================================


.. py:class:: rigidwall_geometric_cylinder_motion.RigidwallGeometricCylinderMotion(**kwargs)
...
.. py:currentmodule:: RigidwallGeometricCylinderMotion
...
.. py:attribute:: subkeyword
   :value: 'GEOMETRIC_CYLINDER_MOTION'
