...
:class:`PartContactPrint`
=========================


.. py:class:: part_contact_print.PartContactPrint(**kwargs)
...
.. py:currentmodule:: PartContactPrint
...
.. code-block:: python
    ...
    from part_contact_print import PartContactPrint
