...
:class:`BoundaryPrescribedMotionSetPointUvw`
============================================


.. py:class:: boundary_prescribed_motion_set_point_uvw.BoundaryPrescribedMotionSetPointUvw(**kwargs)
...
.. py:currentmodule:: BoundaryPrescribedMotionSetPointUvw
...
.. py:attribute:: subkeyword
   :value: 'PRESCRIBED_MOTION_SET_POINT_UVW'
