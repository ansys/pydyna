...
:class:`IncludeStampedPartMatrixInverse`
========================================


.. py:class:: include_stamped_part_matrix_inverse.IncludeStampedPartMatrixInverse(**kwargs)
...
.. py:currentmodule:: IncludeStampedPartMatrixInverse
...
.. py:attribute:: subkeyword
   :value: 'STAMPED_PART_MATRIX_INVERSE'
