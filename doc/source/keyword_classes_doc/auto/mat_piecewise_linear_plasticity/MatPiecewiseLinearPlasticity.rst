...
.. py:class:: mat_piecewise_linear_plasticity.MatPiecewiseLinearPlasticity(**kwargs)
...
.. py:currentmodule:: MatPiecewiseLinearPlasticity
...
.. py:attribute:: subkeyword
   :value: 'PIECEWISE_LINEAR_PLASTICITY'
