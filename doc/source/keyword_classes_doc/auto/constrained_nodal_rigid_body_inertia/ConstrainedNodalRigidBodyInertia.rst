...
:class:`ConstrainedNodalRigidBodyInertia`
=========================================


.. py:class:: constrained_nodal_rigid_body_inertia.ConstrainedNodalRigidBodyInertia(**kwargs)
...
.. py:currentmodule:: ConstrainedNodalRigidBodyInertia
...
.. py:attribute:: subkeyword
   :value: 'NODAL_RIGID_BODY_INERTIA'
