...
:class:`ConstrainedJointScrew`
==============================


.. py:class:: constrained_joint_screw.ConstrainedJointScrew(**kwargs)
...
.. py:currentmodule:: ConstrainedJointScrew
...
.. tab-set::
   ...
   .. tab-item:: Properties
      ...
      .. list-table::
          ...
          * - :py:attr:`~parm`
            - Get or set the Define the helix ratio. Relation from translational velocity to angular velocity.
          * - :py:attr:`~lcid`
            - Get or set the Not to be defined.
          * - :py:attr:`~type`
            - Get or set the Not to be defined.
