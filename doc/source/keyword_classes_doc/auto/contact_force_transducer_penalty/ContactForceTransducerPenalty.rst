...
.. py:class:: contact_force_transducer_penalty.ContactForceTransducerPenalty(**kwargs)
...
.. py:currentmodule:: ContactForceTransducerPenalty
...
.. py:attribute:: subkeyword
   :value: 'FORCE_TRANSDUCER_PENALTY'
