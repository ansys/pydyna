...
:class:`ConstrainedNodalRigidBodySpcOverride`
=============================================


.. py:class:: constrained_nodal_rigid_body_spc_override.ConstrainedNodalRigidBodySpcOverride(**kwargs)
...
.. py:currentmodule:: ConstrainedNodalRigidBodySpcOverride
...
.. py:attribute:: subkeyword
   :value: 'NODAL_RIGID_BODY_SPC_OVERRIDE'
