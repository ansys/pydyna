...
:class:`LoadPointUvwSet`
========================


.. py:class:: load_point_uvw_set.LoadPointUvwSet(**kwargs)

   Bases: :py:obj:`ansys.dyna.core.lib.keyword_base.KeywordBase`


   
   DYNA LOAD_POINT_UVW_SET keyword
...
.. py:currentmodule:: LoadPointUvwSet
...
.. tab-set::
   ...
   .. tab-item:: Properties
      ...
      .. list-table::
          ...
          * - :py:attr:`~pid`
            - Get or set the Parametric point set ID for the SET keyword option; see *SET_IGA_POINT_UVW
          * - :py:attr:`~dof`
