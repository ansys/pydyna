...
.. py:class:: frequency_domain_ssd_direct.FrequencyDomainSsdDirect(**kwargs)
...
.. py:currentmodule:: FrequencyDomainSsdDirect
...
.. code-block:: python
    ...
    from frequency_domain_ssd_direct import FrequencyDomainSsdDirect
