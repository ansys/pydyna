...
:class:`RigidwallGeometricSphereDisplay`
========================================


.. py:class:: rigidwall_geometric_sphere_display.RigidwallGeometricSphereDisplay(**kwargs)
...
.. py:currentmodule:: RigidwallGeometricSphereDisplay
...
.. py:attribute:: subkeyword
   :value: 'GEOMETRIC_SPHERE_DISPLAY'
