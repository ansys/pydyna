...
:class:`MatAddPropertyDependence`
=================================


.. py:class:: mat_add_property_dependence.MatAddPropertyDependence(**kwargs)
...
.. py:currentmodule:: MatAddPropertyDependence
