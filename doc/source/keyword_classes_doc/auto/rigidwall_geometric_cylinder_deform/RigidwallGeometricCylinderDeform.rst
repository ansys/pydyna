...
:class:`RigidwallGeometricCylinderDeform`
=========================================


.. py:class:: rigidwall_geometric_cylinder_deform.RigidwallGeometricCylinderDeform(**kwargs)
...
.. py:currentmodule:: RigidwallGeometricCylinderDeform
...
.. py:attribute:: subkeyword
   :value: 'GEOMETRIC_CYLINDER_DEFORM'
