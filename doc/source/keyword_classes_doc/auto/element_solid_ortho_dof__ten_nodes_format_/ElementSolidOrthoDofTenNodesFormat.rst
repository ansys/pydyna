...
:class:`ElementSolidOrthoDofTenNodesFormat`
===========================================


.. py:class:: element_solid_ortho_dof__ten_nodes_format_.ElementSolidOrthoDofTenNodesFormat(**kwargs)
...
.. py:currentmodule:: ElementSolidOrthoDofTenNodesFormat
...
.. py:attribute:: subkeyword
   :value: 'SOLID_ORTHO_DOF (ten nodes format)'
