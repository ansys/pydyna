...
:class:`MatPiecewiseLinearPlasticity2D`
=======================================


.. py:class:: mat_piecewise_linear_plasticity_2d.MatPiecewiseLinearPlasticity2D(**kwargs)
...
.. py:currentmodule:: MatPiecewiseLinearPlasticity2D
...
.. py:attribute:: subkeyword
   :value: 'PIECEWISE_LINEAR_PLASTICITY_2D'
