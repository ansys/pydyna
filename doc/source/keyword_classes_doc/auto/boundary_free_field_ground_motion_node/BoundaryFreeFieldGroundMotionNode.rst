...
:class:`BoundaryFreeFieldGroundMotionNode`
==========================================


.. py:class:: boundary_free_field_ground_motion_node.BoundaryFreeFieldGroundMotionNode(**kwargs)
...
.. py:currentmodule:: BoundaryFreeFieldGroundMotionNode
...
.. py:attribute:: subkeyword
   :value: 'FREE_FIELD_GROUND_MOTION_NODE'
