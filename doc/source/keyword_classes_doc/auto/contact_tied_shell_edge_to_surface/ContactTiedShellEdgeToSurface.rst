...
.. py:class:: contact_tied_shell_edge_to_surface.ContactTiedShellEdgeToSurface(**kwargs)
...
.. py:currentmodule:: ContactTiedShellEdgeToSurface
...
.. py:attribute:: subkeyword
   :value: 'TIED_SHELL_EDGE_TO_SURFACE'
