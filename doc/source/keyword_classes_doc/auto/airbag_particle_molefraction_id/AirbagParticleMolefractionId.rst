...
:class:`AirbagParticleMolefractionId`
=====================================


.. py:class:: airbag_particle_molefraction_id.AirbagParticleMolefractionId(**kwargs)
...
.. py:currentmodule:: AirbagParticleMolefractionId
...
.. py:attribute:: subkeyword
   :value: 'PARTICLE_MOLEFRACTION_ID'
