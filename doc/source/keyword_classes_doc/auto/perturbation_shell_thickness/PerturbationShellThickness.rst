...
:class:`PerturbationShellThickness`
===================================


.. py:class:: perturbation_shell_thickness.PerturbationShellThickness(**kwargs)
...
.. py:currentmodule:: PerturbationShellThickness
...
.. tab-set::
   ...
   .. tab-item:: Properties
      ...
      .. list-table::
          ...
          * - :py:attr:`~eid`
            - Get or set the Element set ID. Specify 0 to perturb all the elements in the model.
          * - :py:attr:`~scl`
