...
:class:`RigidwallPlanarFiniteMovingForces`
==========================================


.. py:class:: rigidwall_planar_finite_moving_forces.RigidwallPlanarFiniteMovingForces(**kwargs)
...
.. py:currentmodule:: RigidwallPlanarFiniteMovingForces
...
.. py:attribute:: subkeyword
   :value: 'PLANAR_FINITE_MOVING_FORCES'
