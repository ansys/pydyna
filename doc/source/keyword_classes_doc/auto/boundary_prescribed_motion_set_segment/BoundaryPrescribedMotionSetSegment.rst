...
:class:`BoundaryPrescribedMotionSetSegment`
===========================================


.. py:class:: boundary_prescribed_motion_set_segment.BoundaryPrescribedMotionSetSegment(**kwargs)
...
.. py:currentmodule:: BoundaryPrescribedMotionSetSegment
...
.. py:attribute:: subkeyword
   :value: 'PRESCRIBED_MOTION_SET_SEGMENT'
