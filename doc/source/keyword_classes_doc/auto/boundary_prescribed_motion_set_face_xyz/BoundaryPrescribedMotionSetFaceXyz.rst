...
:class:`BoundaryPrescribedMotionSetFaceXyz`
===========================================


.. py:class:: boundary_prescribed_motion_set_face_xyz.BoundaryPrescribedMotionSetFaceXyz(**kwargs)
...
.. py:currentmodule:: BoundaryPrescribedMotionSetFaceXyz
...
.. py:attribute:: subkeyword
   :value: 'PRESCRIBED_MOTION_SET_FACE_XYZ'
