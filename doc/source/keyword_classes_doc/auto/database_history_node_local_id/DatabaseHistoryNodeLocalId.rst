...
:class:`DatabaseHistoryNodeLocalId`
===================================


.. py:class:: database_history_node_local_id.DatabaseHistoryNodeLocalId(**kwargs)
...
.. py:currentmodule:: DatabaseHistoryNodeLocalId
