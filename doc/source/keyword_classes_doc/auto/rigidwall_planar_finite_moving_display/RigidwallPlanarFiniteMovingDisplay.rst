...
:class:`RigidwallPlanarFiniteMovingDisplay`
===========================================


.. py:class:: rigidwall_planar_finite_moving_display.RigidwallPlanarFiniteMovingDisplay(**kwargs)
...
.. py:currentmodule:: RigidwallPlanarFiniteMovingDisplay
...
.. py:attribute:: subkeyword
   :value: 'PLANAR_FINITE_MOVING_DISPLAY'
