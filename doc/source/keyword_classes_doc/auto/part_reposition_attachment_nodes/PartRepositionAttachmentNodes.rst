...
:class:`PartRepositionAttachmentNodes`
======================================


.. py:class:: part_reposition_attachment_nodes.PartRepositionAttachmentNodes(**kwargs)
...
.. py:currentmodule:: PartRepositionAttachmentNodes
...
.. code-block:: python
    ...
    from part_reposition_attachment_nodes import PartRepositionAttachmentNodes
...
.. py:attribute:: subkeyword
   :value: 'REPOSITION_ATTACHMENT_NODES'
