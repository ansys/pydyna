...
.. py:class:: contact_tied_shell_edge_to_solid.ContactTiedShellEdgeToSolid(**kwargs)
...
.. py:currentmodule:: ContactTiedShellEdgeToSolid
...
.. py:attribute:: subkeyword
   :value: 'TIED_SHELL_EDGE_TO_SOLID'
