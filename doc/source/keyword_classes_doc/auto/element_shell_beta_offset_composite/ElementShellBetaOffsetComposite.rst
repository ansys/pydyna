...
:class:`ElementShellBetaOffsetComposite`
========================================


.. py:class:: element_shell_beta_offset_composite.ElementShellBetaOffsetComposite(**kwargs)
...
.. py:currentmodule:: ElementShellBetaOffsetComposite
...
.. py:attribute:: subkeyword
   :value: 'SHELL_BETA_OFFSET_COMPOSITE'
