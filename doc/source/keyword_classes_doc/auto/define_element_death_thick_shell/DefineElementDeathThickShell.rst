...
:class:`DefineElementDeathThickShell`
=====================================


.. py:class:: define_element_death_thick_shell.DefineElementDeathThickShell(**kwargs)
...
.. py:currentmodule:: DefineElementDeathThickShell
...
.. py:attribute:: subkeyword
   :value: 'ELEMENT_DEATH_THICK_SHELL'
