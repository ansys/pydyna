...
:class:`RigidwallPlanarFiniteDisplayId`
=======================================


.. py:class:: rigidwall_planar_finite_display_id.RigidwallPlanarFiniteDisplayId(**kwargs)
...
.. py:currentmodule:: RigidwallPlanarFiniteDisplayId
...
.. py:attribute:: subkeyword
   :value: 'PLANAR_FINITE_DISPLAY_ID'
