...
:class:`MatSimplifiedRubberFoamLogLogInterpolationWithFailure`
==============================================================


.. py:class:: mat_simplified_rubber_foam_log_log_interpolation_with_failure.MatSimplifiedRubberFoamLogLogInterpolationWithFailure(**kwargs)

   Bases: :py:obj:`ansys.dyna.core.lib.keyword_base.KeywordBase`


   
   DYNA MAT_SIMPLIFIED_RUBBER/FOAM_LOG_LOG_INTERPOLATION_WITH_FAILURE keyword
...
.. py:currentmodule:: MatSimplifiedRubberFoamLogLogInterpolationWithFailure
...
.. py:attribute:: subkeyword
   :value: 'SIMPLIFIED_RUBBER/FOAM_LOG_LOG_INTERPOLATION_WITH_FAILURE'
