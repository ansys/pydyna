...
:class:`DefineFrictionAirbagSingleSurface`
==========================================


.. py:class:: define_friction_airbag_single_surface.DefineFrictionAirbagSingleSurface(**kwargs)
...
.. py:currentmodule:: DefineFrictionAirbagSingleSurface
...
.. py:attribute:: subkeyword
   :value: 'FRICTION_AIRBAG_SINGLE_SURFACE'
