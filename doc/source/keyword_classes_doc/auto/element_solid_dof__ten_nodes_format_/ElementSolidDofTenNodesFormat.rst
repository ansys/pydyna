...
:class:`ElementSolidDofTenNodesFormat`
======================================


.. py:class:: element_solid_dof__ten_nodes_format_.ElementSolidDofTenNodesFormat(**kwargs)
...
.. py:currentmodule:: ElementSolidDofTenNodesFormat
...
.. py:attribute:: subkeyword
   :value: 'SOLID_DOF (ten nodes format)'
