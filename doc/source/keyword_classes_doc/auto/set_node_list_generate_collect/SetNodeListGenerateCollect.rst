...
:class:`SetNodeListGenerateCollect`
===================================


.. py:class:: set_node_list_generate_collect.SetNodeListGenerateCollect(**kwargs)
...
.. py:currentmodule:: SetNodeListGenerateCollect
...
.. tab-set::
   ...
   .. tab-item:: Properties
      ...
      .. list-table::
          ...
          * - :py:attr:`~b2beg`
            - Get or set the First node ID in the second block.
          * - :py:attr:`~b2end`
            - Get or set the Last node ID in the second block.
          * - :py:attr:`~b3beg`
            - Get or set the First node ID in the third block.
          * - :py:attr:`~b3end`
            - Get or set the Last node ID in the third block.
          * - :py:attr:`~b4beg`
            - Get or set the First node ID in the fourth block.
          * - :py:attr:`~b4end`
            - Get or set the Last node ID in the fourth block.
          * - :py:attr:`~title`
...
.. py:attribute:: subkeyword
   :value: 'NODE_LIST_GENERATE_COLLECT'
