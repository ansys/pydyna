...
:class:`DefineFrictionAutomaticNodesToSurface`
==============================================


.. py:class:: define_friction_automatic_nodes_to_surface.DefineFrictionAutomaticNodesToSurface(**kwargs)
...
.. py:currentmodule:: DefineFrictionAutomaticNodesToSurface
...
.. py:attribute:: subkeyword
   :value: 'FRICTION_AUTOMATIC_NODES_TO_SURFACE'
