...
:class:`ElementShellThicknessMcidOffset`
========================================


.. py:class:: element_shell_thickness_mcid_offset.ElementShellThicknessMcidOffset(**kwargs)
...
.. py:currentmodule:: ElementShellThicknessMcidOffset
...
.. py:attribute:: subkeyword
   :value: 'SHELL_THICKNESS_MCID_OFFSET'
